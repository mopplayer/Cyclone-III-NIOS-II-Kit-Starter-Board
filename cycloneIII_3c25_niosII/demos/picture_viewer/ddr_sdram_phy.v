...
module ddr_sdram_phy (
	...
	defparam
		ddr_sdram_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		ddr_sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		ddr_sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		ddr_sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		ddr_sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		ddr_sdram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		ddr_sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		ddr_sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 4,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 7519,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "7519 ps",
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 50,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		ddr_sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
		ddr_sdram_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		ddr_sdram_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		ddr_sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		ddr_sdram_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="ddr_sdram_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/build/arc/execute/dir_4943/_0/regtest/devkits/c3_3c25_neek/picture_viewer/ddr_sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
