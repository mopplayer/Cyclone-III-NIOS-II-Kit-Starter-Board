...
#  xxx Company, xxx Street, xxx City, xxx Country
...
add_parameter "system_clock_frequency" "integer" "50000000" "The clock frequency in Hertz used to drive the Avalon interface"
set_parameter_property "system_clock_frequency" "displayName" "Bus Clock Frequency (Hz)"
set_parameter_property "system_clock_frequency" "units" "Hertz"

add_parameter "spi_clock_frequency" "integer" "20000000" "The clock frequency in Hertz used to drive the SPI interface"
set_parameter_property "spi_clock_frequency" "displayName" "SPI Clock (Hz)"
set_parameter_property "spi_clock_frequency" "units" "Hertz"
set_parameter_property "spi_clock_frequency" "allowedRanges" "1:50000000"
...
proc validate {} {
  ...
  set actual_clk [ expr $system_clock_frequency / ($target_clock_divider * 2) ]
  ...
  set actual_clk_khz [ expr $actual_clk / 1000 ]
  send_message "info" "Actual Rate = $actual_clk_khz kHz  Error: $clk_truncated_percent_error %%"
}
...
proc calculate_parameters {} {
  ...
  # Divide by two for the divisor the RTL wants and round up if necessary
  set target_clock_divider [ expr ceil( $target_clock_divider / 2) ]
}
