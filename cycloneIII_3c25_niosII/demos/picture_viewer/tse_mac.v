...
module tse_mac (
	...
	defparam
		...
		altera_tse_mac_inst.EG_FIFO = 512,
		altera_tse_mac_inst.EG_ADDR = 9,
		altera_tse_mac_inst.ING_FIFO = 512,
		altera_tse_mac_inst.ENABLE_ENA = 32,
		altera_tse_mac_inst.ING_ADDR = 9,
...
// Retrieval info:      <PRIVATE name = "eg_addr" value="9"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "eg_fifo" value="512"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "ing_addr" value="9"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "ing_fifo" value="512"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "uiEgFIFOSize" value="512 x 32 Bits"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "uiHostClockFrequency" value="0"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "uiIngFIFOSize" value="512 x 32 Bits"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "project_name" value="cycloneIII_embedded_evaluation_kit_picture_viewer_sopc"  type="STRING"  enable="1" />
