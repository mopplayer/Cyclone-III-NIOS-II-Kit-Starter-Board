...
lappend patterns ck_n ${instname}_alt_mem_phy_inst|clk|DDR_CLK_OUT\[*\].ddr_clk_out_n|auto_generated|ddio_outa\[*\]|dataout
	...
	set outputFileName "frame_buffer_phy_autodetectedpins.tcl"
...
set frame_buffer_phy_use_high_performance_timing 1
if {[namespace which -variable ::override_frame_buffer_phy_use_high_performance_timing] != ""} {
	set frame_buffer_phy_use_high_performance_timing $::override_frame_buffer_phy_use_high_performance_timing
}
