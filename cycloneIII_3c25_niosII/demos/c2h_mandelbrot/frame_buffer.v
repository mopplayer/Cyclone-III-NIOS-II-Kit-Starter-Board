// megafunction wizard: %DDR High Performance Controller v12.0%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			frame_buffer_controller_phy
// ============================================================
// Generated by DDR High Performance Controller 12.0 [Altera, IP Toolbench 1.3.0 Build 178]
// ************************************************************
...
module frame_buffer (
	...
	frame_buffer_controller_phy	frame_buffer_controller_phy_inst(
...
// Retrieval info: <MEGACORE title="DDR SDRAM Controller with ALTMEMPHY"  version="12.0"  build="178"  iptb_version="1.3.0 Build 178"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="frame_buffer_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="frame_buffer_auk_ddr_hp_controller_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="frame_buffer_phy_alt_mem_phy_seq.vhd,frame_buffer_phy_alt_mem_phy_seq_wrapper.vhd,frame_buffer_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="frame_buffer_auk_ddr_hp_controller_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+frame_buffer_alt_mem_phy_seq_wrapper;+frame_buffer_alt_mem_phy_reconfig;+frame_buffer_alt_mem_phy_pll;+frame_buffer_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\c2h_mandelbrot/frame_buffer_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="frame_buffer_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
