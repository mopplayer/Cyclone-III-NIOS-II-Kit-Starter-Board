...
module frame_buffer_phy (
	...
	frame_buffer_phy_alt_mem_phy	frame_buffer_phy_alt_mem_phy_inst(
	...
	defparam
		frame_buffer_phy_alt_mem_phy_inst.FAMILY = "Cyclone III",
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		frame_buffer_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		frame_buffer_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		frame_buffer_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		frame_buffer_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		frame_buffer_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		frame_buffer_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		frame_buffer_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6667,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6667 ps",
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 50,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		frame_buffer_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
		frame_buffer_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		frame_buffer_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		frame_buffer_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		frame_buffer_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="frame_buffer_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "ref_clk_source" value="ext_clk_one"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="frame_buffer_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="frame_buffer_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+frame_buffer_phy_alt_mem_phy_seq_wrapper;+frame_buffer_phy_alt_mem_phy_reconfig;+frame_buffer_phy_alt_mem_phy_pll;+frame_buffer_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\c2h_mandelbrot/frame_buffer_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="frame_buffer_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP3C25F324C7"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "FAMILY" value="Cyclone III"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
