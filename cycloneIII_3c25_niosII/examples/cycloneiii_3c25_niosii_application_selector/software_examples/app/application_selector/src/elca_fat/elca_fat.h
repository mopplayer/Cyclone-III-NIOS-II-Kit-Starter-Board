...
//
//
//   History    : Jan. 3, 2006   - Initial Release
//
//
///////////////////////////////////////////////////////////////////////////////
...
// spare program memory by deciding if we want to use FAT12, FAT16
...
struct FindFile
{
  ...
  char ff_name[13];         // 8.3 DOS filename with '.' in it and \0 at the end for elca_fopen()
#ifdef USE_FINDLONG
