...
//////////////////////////////////////////////////////////////////////////////
//                  General constants for splash screen                     //
//////////////////////////////////////////////////////////////////////////////

#define SPLASH_SCREEN_TEXT                "Starting Up..."
#define SPLASH_SCREEN_PROGRESS_BAR_Y_START 390
#define SPLASH_SCREEN_PROGRESS_BAR_WIDTH  300
#define SPLASH_SCREEN_PROGRESS_BAR_HEIGHT 15
#define SPLASH_SCREEN_PROGRESS_BAR_COLOR  0x005C76B1
...
#define MAIN_MENU_NUM_COMMAND_BUTTONS           3
...
#define MAIN_MENU_INFO_BUTTON_X_START           178
#define MAIN_MENU_INFO_BUTTON_Y_START           410
#define MAIN_MENU_INFO_BUTTON_TEXT              "Show Info"

#define MAIN_MENU_WEB_BUTTON_INDEX              2
#define MAIN_MENU_WEB_BUTTON_X_START            500
#define MAIN_MENU_WEB_BUTTON_Y_START            410
#define MAIN_MENU_WEB_BUTTON_X_SIZE             280
#define MAIN_MENU_WEB_BUTTON_TEXT               "Not Connected"
...
//////////////////////////////////////////////////////////////////////////////
//                Constants for Web Info Screen                     //
//////////////////////////////////////////////////////////////////////////////
#define WEB_SCREEN_TITLE_Y_START_1             15
#define WEB_SCREEN_TITLE_Y_START_2             55
#define WEB_SCREEN_TITLE_TEXT1                 "Web Server Info"

#define WEB_SCREEN_NUM_COMMAND_BUTTONS         1

#define WEB_SCREEN_OK_BUTTON_INDEX             0
#define WEB_SCREEN_OK_BUTTON_X_START           80
#define WEB_SCREEN_OK_BUTTON_Y_START           410
#define WEB_SCREEN_OK_BUTTON_TEXT              "OK"
...
#define QUESTION_WINDOW_Y_HEIGHT                170
...
//////////////////////////////////////////////////////////////////////////////
//                 Constants for progress bar windows                       //
//////////////////////////////////////////////////////////////////////////////
...
#define SCROLL_BUTTON_X_START                   (MENU_ITEM_X_START + MENU_ITEM_X_WIDTH + 10 + MENU_ITEM_BORDER_WIDTH )
#define SCROLL_BUTTON_WIDTH                     66
#define SCROLL_BUTTON_HEIGHT                    66

#define SCROLL_DOWN_INDEX 0
#define SCROLL_DOWN_BUTTON_X_START              SCROLL_BUTTON_X_START
#define SCROLL_DOWN_BUTTON_Y_START              (((MENU_ITEM_Y_START + (MENU_ITEM_Y_HEIGHT * (MENU_ITEMS_ON_SCREEN_AT_ONCE))) - SCROLL_BUTTON_HEIGHT) - 8)
...
#define SCROLL_INDICATOR_CORNER_RADIUS          10
