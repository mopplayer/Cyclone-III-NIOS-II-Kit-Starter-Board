...
// Flash-device parameters.  Modify for other P30 family members.
#define FLASH_INTEL_P30_NUM_128K_BLOCKS  127
#define FLASH_INTEL_P30_NUM_32K_BLOCKS     4
#define FLASH_INTEL_P30_BOTTOM_BOOT_BLOCK  1
