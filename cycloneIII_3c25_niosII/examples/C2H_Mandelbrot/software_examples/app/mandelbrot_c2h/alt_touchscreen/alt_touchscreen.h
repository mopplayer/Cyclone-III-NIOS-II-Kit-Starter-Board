...
typedef struct alt_touchscreen_struct
{
  ...
  // pointers to my supporting devices & HAL constructs
  alt_alarm alarm;

  // State-holding internal structures.
  ...
  // Scaling data for the screen
  unsigned int x_left_adc_value;
  unsigned int x_right_adc_value;
  int          x_left_screen_coordinate;
  int          x_right_screen_coordinate;

  unsigned int y_bottom_adc_value;
  unsigned int y_top_adc_value;
  int          y_bottom_screen_coordinate;
  int          y_top_screen_coordinate;
